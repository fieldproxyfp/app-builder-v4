...
function setResponsiveTypography() {
  ...
  document.documentElement.style.setProperty('--line-height-multiplier', lineHeightMultiplier.toString());
  document.documentElement.style.setProperty('--letter-spacing-multiplier', letterSpacingMultiplier.toString());
}
